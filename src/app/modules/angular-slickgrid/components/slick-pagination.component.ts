...
//Added Manually : End
  ...
  changeToLastPage(event: any) {
    ...
    this.onPageChanged(event, this.pageNumber);
    this.lowerRange=(this.pageCount>5)?this.pageCount-4:1;
    this.UpperRange=this.pageCount;
    this.DoPaging();
  }
  ...
  changeToNextPage(event: any) {
    ...
    if (this.pageNumber < this.pageCount) {
      this.pageNumber++;
      this.onPageChanged(event, this.pageNumber);
      if((this.UpperRange+1)<=this.pageCount){
        this.lowerRange=this.lowerRange+1;
        this.UpperRange=this.UpperRange+1;
        this.DoPaging();
      }
    }
  }
...
//This mmethod creates numbering of the pagination depending upon the pagesize
   DoPaging(){
      if(this.UpperRange<=this.pageCount){
        this.Pages=[];
  ...
  refreshPagination(isPageNumberReset: boolean = false) {
    ...
    this.UpperRange=this.UpperRange>this.pageCount?this.pageCount:this.UpperRange;
  ...
  recalculateFromToIndexes() {
    ...
    _changeToCurrentPage(PageNumber){
